...
public class GraceException extends Exception{
    ...
    public GraceException(final int errCode, final String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }

    public GraceException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }

    public GraceException(final int errCode, final String errMsg, final Throwable throwable) {
