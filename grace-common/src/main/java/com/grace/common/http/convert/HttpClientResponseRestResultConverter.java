...
import com.grace.common.http.convert.exception.ConvertException;
    ...
    public RestResult<T> convert(Object source) throws IOException {
        ...
        if(source instanceof HttpClientResponse){
            try {
                ...
                // 获取响应头
                final Header responseHeader = httpClientResponse.getResponseHeader();
                // 获取响应结果JSON
                ...
                restResult.setHeader(responseHeader);
                return restResult;
            }catch (Exception e){
